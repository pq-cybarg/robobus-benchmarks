...
def page(title, active, body, prefix="", extra_head="", desc="", canon=""):
    ...
    return (f"<!doctype html><html lang='en'><head><meta charset='utf-8'>"
            ...
            f"robobus is presently All Rights Reserved; a source-available license (the Business Source "
            f"License 1.1) is under consideration. This site's own code is presently All Rights "
            f"Reserved.</div>"
