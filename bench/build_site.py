...
<header class='hero'><div class='wrap reveal'>
  ...
  <p class='lede'>robobus is a sub-microsecond shared-memory bus, CNSA&nbsp;2.0 post-quantum crypto,
  and PQC-hardened DDS-Security — benchmarked end to end by one portable script that records
  exactly what each platform can and can't do.</p>
  <div class='cta'>
